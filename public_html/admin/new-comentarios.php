                      ...
                      <table class="table bg-gradient-dark text-white" id="dataTable" width="100%" cellspacing="0">
                       ...
                       <tr>
                        ...
                        <tr>
                          ...
                          <td><input type="text" id="txtDireccion" name="tDireccion[calle]"  size="15" class="bg-danger text-white">
                          <input type="text" id="txtDireccion" name="tDireccion[altura]"  size="5" class="bg-danger text-white">
                          <input type="text" id="txtDireccion" name="tDireccion[piso]"  size="5" class="bg-danger text-white">
                          <input type="text" id="txtDireccion" name="tDireccion[depto]" size="5" class="bg-danger text-white">
                          <input type="text" id="txtDireccion" name="tDireccion[barrio]"  size="15" class="bg-danger text-white"></td>
                        </tr>
