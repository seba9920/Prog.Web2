                ...
                <table class="table table-bordered" id="tablajson" width="100%" cellspacing="0">
                  ...
                  <tr>
                    ...
                    foreach($datos as $d){?>
                        ...
                        <td><?php echo $d['tPrecio']; ?></td>      
                        <td><?php echo $d['tClasi']; ?></td>  
                        <td><?php echo $d['tGene']; ?></td>  
                        <td><?php echo $d['tAnio']; ?></td>  
                        <td><?php echo $d['tDirect']; ?></td> 
                        <td><?php echo $d['tActor']; ?></td>   
                        <td><?php echo $d['tDescripcion']; ?></td>  
                        <?php 
                    }?>
